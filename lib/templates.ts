...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    elements: [
      { id: nid(), type: 'bodyText', x: 0.1, y: 0.18, text: 'TRENDING · WEEK OF AUG 28', fontSize: 11, color: '#e07a3f', font: 'Inter, system-ui, sans-serif', lineHeight: 1.2, width: 0.8, align: 'left', snap: 'free' },
      { id: nid(), type: 'headingNumber', x: 0.1, y: 0.28, number: '5', fontSize: 130, color: '#e07a3f', font: 'Georgia, serif', italic: true, snap: 'free' },
      { id: nid(), type: 'headingText', x: 0.3, y: 0.32, text: 'GitHub repos that cooked this week', fontSize: 32, color: '#111111', font: 'Georgia, serif', lineHeight: 1.05, bold: false, width: 0.62, align: 'left', shadow: false, snap: 'free' },
      { id: nid(), type: 'bodyText', x: 0.1, y: 0.75, text: 'and which ones I would use', fontSize: 15, color: '#4a4a4a', font: 'Georgia, serif', lineHeight: 1.2, width: 0.8, align: 'left', snap: 'free' },
    ],
  },
  {
    id: 'editorialOutro',
    ...
    elements: [
      ...
      { id: nid(), type: 'bodyText', x: 0.1, y: 0.5, text: 'Save this post for later and follow for more weekly drops.', fontSize: 15, color: '#4a4a4a', font: 'Inter, system-ui, sans-serif', lineHeight: 1.4, width: 0.8, align: 'left', snap: 'free' },
  ...
  // ---------- Split quote set ----------
  {
    ...
    name: 'Split Quote ⭐',
    emoji: '🎤',
    tagline: 'Two photos up top, big quote below. Jay-Z style.',
    config: {
      backgroundImage: null,
      paperBg: 'none',
      headline: '',
    ...
    elements: [
      ...
      { id: nid(), type: 'headingText', x: 0.055, y: 0.62, text: 'THEY RUNNING OUTTA CHARACTERS, HAD TO BRING BACK UP KAEP AGAIN…', fontSize: 26, color: '#ffffff', font: 'Inter, system-ui, sans-serif', lineHeight: 1.12, bold: true, width: 0.89, align: 'left', shadow: true, snap: 'free' },
      { id: nid(), type: 'attribution', x: 0.055, y: 0.89, text: '-JAY-Z, YANKEE STADIUM FREESTYLE (2026)', fontSize: 12, color: '#ffffff', font: 'Inter, system-ui, sans-serif', letterSpacing: 0.5, uppercase: false, bold: true, width: 0.89, align: 'left', snap: 'free' },
    ],
  },
  {
    id: 'splitQuoteDark',
    ...
    emoji: '🎬',
    tagline: 'Same layout, no quote mark, cleaner look.',
    config: {
      backgroundImage: null,
      paperBg: 'none',
      headline: '',
    ...
    elements: [
      ...
      { id: nid(), type: 'headingText', x: 0.055, y: 0.6, text: 'YOUR BIG QUOTE GOES RIGHT HERE — MAKE IT COUNT.', fontSize: 28, color: '#ffffff', font: 'Impact, "Arial Black", sans-serif', lineHeight: 1.1, bold: true, width: 0.89, align: 'left', shadow: true, snap: 'free' },
      { id: nid(), type: 'attribution', x: 0.055, y: 0.9, text: '-YOUR NAME, SOURCE (2026)', fontSize: 12, color: '#ffffff', font: 'Inter, system-ui, sans-serif', letterSpacing: 0.5, uppercase: false, bold: true, width: 0.89, align: 'left', snap: 'free' },
    ],
  },
  {
    id: 'memorial',
    name: 'Memorial',
    emoji: '🎂',
    tagline: 'Full photo, circle inset, birthday or tribute post.',
    config: {
      backgroundImage: null,
      paperBg: 'none',
      headline: '',
    ...
    elements: [
      ...
      { id: nid(), type: 'headingText', x: 0.055, y: 0.6, text: 'HAPPY BIRTHDAY TO THE LATE JAMES GANDOLFINI—WHO WAS ALWAYS DOWN FOR NY', fontSize: 24, color: '#ffffff', font: 'Impact, "Arial Black", sans-serif', lineHeight: 1.12, bold: true, width: 0.89, align: 'left', shadow: true, snap: 'free' },
